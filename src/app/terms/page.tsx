...
export default function TermsPage() {
  return (
    <div className="pt-24 min-h-screen bg-slate-50 dark:bg-[#050814] text-slate-900 dark:text-white transition-colors duration-300">
      {/* Header */}
      <section className="py-16 bg-[#030714] text-white border-b border-white/10 text-center">
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-10 text-sm sm:text-base leading-relaxed text-slate-700 dark:text-slate-300">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white mb-3 font-display">
          ...
          <div>
            ...
            <p>
              ...
              <Link href="/privacy" className="text-cyan-600 dark:text-cyan-400 underline font-medium">
                Privacy Policy
              </Link>
              .
            </p>
          ...
          <div>
            ...
            <p>
              ...
              <a href="mailto:info@orbytesglobal.com" className="text-cyan-600 dark:text-cyan-400 font-semibold underline">
