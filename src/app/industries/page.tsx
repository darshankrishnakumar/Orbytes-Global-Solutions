...
export default function IndustriesHubPage() {
  ...
  return (
    <div className="pt-24 transition-colors duration-300">
      ...
      {/* 2. Structured Industry Sectors [DARK] */}
              ...
              <div key={cat.id} className="space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-white/10 pb-4">
                  <div className="flex items-start gap-4">
                    <div className="h-12 w-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-cyan-400 shrink-0 mt-1">
